import template from './sw-cms-el-config-ofcp-product-detail-widget.html.twig';
import './sw-cms-el-config-ofcp-product-detail-widget.scss';
...
export default {
    ...
    computed: {
        ...
        uploadTag() {
            return `cms-element-ofcp-product-detail-widget-config-${this.element.id}`;
        },
    ...
    methods: {
        ...
        createdComponent() {
            console.log('createdComponent config');
